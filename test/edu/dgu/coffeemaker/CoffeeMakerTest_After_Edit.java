...
public class CoffeeMakerTest_After_Edit{
	...
	public void testAddInventory1() throws InventoryException {
		coffeeMaker.addInventory("4", "6", "5", "9");
	}
	...
	public void testAddInventory2_NG() throws InventoryException {
		coffeeMaker.addInventory("-3", "1", "2", "3");
	}
	...
	/** 테스트 커버리지를 위한 추가 테스트 케이스 */

	@Test
	public void testRecipeCoverage_Plus() {
		Recipe recipe8 = new Recipe();
        assertTrue(recipe7.equals(recipe8));
		assertFalse(recipe1.equals(recipe3));
		assertFalse(recipe7.equals(recipe4));
		assertNotEquals(recipe1.hashCode(), recipe7.hashCode());
	}
	
	@Test
	public void testRecipeCoverage2_Plus() throws RecipeException {
		recipe7.setPrice("-3000");
		recipe7.setPrice("sP");
		recipe7.setAmtSugar("sasug");
		recipe7.setAmtMilk("samil");
		recipe7.setAmtMilk("-7");
		recipe7.setAmtCoffee("-4");
		recipe7.setAmtCoffee("sacof");
	}

	@Test
	public void testForRecipeBookCoverage_Plus() {
		assertTrue(coffeeMaker.addRecipe(recipe1));
		assertFalse(coffeeMaker.addRecipe(recipe1));
	}

	@Test
	public void testCoffeeMakerCoverage_Plus() {
		int amtPaid = 1000;
		int change = coffeeMaker.makeCoffee(0, amtPaid);
		assertEquals(amtPaid, change);
	}

	@Test
	public void testInventoryCoverage_Plus() throws InventoryException {
		...
		assertFalse(inventory.enoughIngredients(recipe7));
		inventory.addChocolate("choco");
	}

	@Test(expected = InventoryException.class)
	public void testInventoryCoverage2_Plus() throws InventoryException {
		try {
